...
/**
 * Service responsible for synchronizing the [WeeklyTrainingPlan] with a user's Google Calendar.
 *
 ...
 * - **Event Synchronization:** Converts [DailyPlan] entries into all-day calendar events.
 * - **State Tracking:** Uses [CalendarSyncDao] to map local training days to remote Google Calendar event IDs, allowing updates instead of duplicates.
